...
class EmployeeController extends Controller
{
    ...
    #storage old file before change to delete
    $depend_array = [
    ...
    #edit contract
        ...
        if($request->contract_file != null):
            $contract['contract_file']= str_replace('public','storage',$request->file('contract_file')->store('public/contract'));
        endif;
    ...
    #edit employee
        ...
        if($request->personal_identity_img != null):
            $employee_data['personal_identity_img']= str_replace('public','storage',$request->file('personal_identity_img')->store('public/personal_identity_img'));
        endif;

        #avatar
        if($request->avatar != null):
            $employee_data['avatar']= str_replace('public','storage',$request->file('avatar')->store('public/avatar_employee'));
        endif;
