                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group @error('fixed_salary')  has-danger @enderror">
                                            ...
                                            <input type="text" name="fixed_salary" id="fixed_salary" value="{{old('fixed_salary',0)}}" class="form-control   @error('fixed_salary') form-control-danger @enderror" onclick="RemoveError('fixed_salary')" >
...
@section('scripts')
    ...
    <script>
        setTimeout(function (){
            document.getElementById('data_of_start_work').value = "{{old('data_of_start_work',date('d M Y',strtotime(now())))}}";
            document.getElementById('time_of_attendees').value = "{{old('time_of_attendees',date('h:m a',strtotime('08:00')))}}";
            document.getElementById('time_of_going').value = "{{old('time_of_going',date('h:m a',strtotime('16:00')))}}";
        },3000);
    </script>
